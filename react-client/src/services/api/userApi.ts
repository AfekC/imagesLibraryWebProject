...
export const loginUser = async (userDetails: User): Promise<AxiosResponse<{ user: User}, any>> => axiosClient.post('/user/login', userDetails);
...
export const uploadProfileImage = async (file: File): Promise<AxiosResponse<void, any>> => axiosClient.post('/user/update/image', file);
